    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRING:
                    self.FileType = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRING:
                    self.ScheduledDateTime = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 5:
                if ftype == TType.STRING:
                    self.DueDateTime = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 6:
                if ftype == TType.I16:
...
class TNode(object):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRING:
                    self.AoKID = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
                if ftype == TType.SET:
                ...
                if ftype == TType.STRING:
                    self.ProcessingTag = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 11:
                if ftype == TType.MAP:
    ...
    def write(self, oprot):
        ...
        if self.TruthValue is not None:
            ...
            for kiter42, viter43 in self.TruthValue.items():
...
class TRelation(object):
    ...
    def write(self, oprot):
        ...
        if self.IsBiDirectional is not None:
            oprot.writeFieldBegin('IsBiDirectional', TType.BOOL, 7)
        ...
        if self.Properties is not None:
            ...
            for kiter65, viter66 in self.Properties.items():
        ...
        if self.TruthValue is not None:
            ...
            oprot.writeMapBegin(TType.STRING, TType.DOUBLE, len(self.TruthValue))
            for kiter67, viter68 in self.TruthValue.items():
...
class TGraph(object):
    ...
    def __init__(self, ID=None, Nodes=None, Edges=None, RepresentationType=None,):
        self.ID = ID
        self.Nodes = Nodes
        self.Edges = Edges
    ...
    def write(self, oprot):
        ...
        if self.Nodes is not None:
            oprot.writeFieldBegin('Nodes', TType.MAP, 2)
            oprot.writeMapBegin(TType.STRING, TType.STRUCT, len(self.Nodes))
            for kiter83, viter84 in self.Nodes.items():
                oprot.writeString(kiter83.encode('utf-8') if sys.version_info[0] == 2 else kiter83)
                viter84.write(oprot)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        if self.Edges is not None:
            oprot.writeFieldBegin('Edges', TType.MAP, 3)
            oprot.writeMapBegin(TType.STRING, TType.STRUCT, len(self.Edges))
            for kiter85, viter86 in self.Edges.items():
                oprot.writeString(kiter85.encode('utf-8') if sys.version_info[0] == 2 else kiter85)
                viter86.write(oprot)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        if self.RepresentationType is not None:
            oprot.writeFieldBegin('RepresentationType', TType.I32, 4)
...
class TMemoryChunk(object):
    ...
    def __init__(self, ID=None, TimeStamp=None, Graph=None, Capacity=None, AttentionLevel=None, DecayLevel=None, Importance=None, Evaluation=None,):
        self.ID = ID
    ...
    def write(self, oprot):
        ...
        if self.Capacity is not None:
            oprot.writeFieldBegin('Capacity', TType.I16, 4)
            oprot.writeI16(self.Capacity)
            oprot.writeFieldEnd()
        if self.AttentionLevel is not None:
            oprot.writeFieldBegin('AttentionLevel', TType.DOUBLE, 5)
            oprot.writeDouble(self.AttentionLevel)
            oprot.writeFieldEnd()
        if self.DecayLevel is not None:
            oprot.writeFieldBegin('DecayLevel', TType.DOUBLE, 6)
            oprot.writeDouble(self.DecayLevel)
            oprot.writeFieldEnd()
        if self.Importance is not None:
            oprot.writeFieldBegin('Importance', TType.DOUBLE, 7)
            oprot.writeDouble(self.Importance)
            oprot.writeFieldEnd()
        if self.Evaluation is not None:
            oprot.writeFieldBegin('Evaluation', TType.DOUBLE, 8)
            oprot.writeDouble(self.Evaluation)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class TCognitiveMemory(object):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.STRING:
                    self.Memory = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                if ftype == TType.STRING:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i91 in range(_size87):
                        ...
                        _val93 = TMemoryChunk()
                        _val93.read(iprot)
                        self.MemoryChunks[_key92] = _val93
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 5:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i98 in range(_size94):
                        ...
                        _val100 = TDimension()
                        _val100.read(iprot)
                        self.Scratchpad[_key99] = _val100
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.MemoryChunks is not None:
            ...
            for kiter101, viter102 in self.MemoryChunks.items():
        ...
        if self.Scratchpad is not None:
            ...
            for kiter103, viter104 in self.Scratchpad.items():
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRING:
                    self.Calibration = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
...
class TUser(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i109 in range(_size105):
                        ...
                        self.RegisteredDevices.append(_elem110)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.RegisteredDevices is not None:
            ...
            for iter111 in self.RegisteredDevices:
...
TRelation.thrift_spec = (
    ...
    (7, TType.BOOL, 'IsBiDirectional', None, None, ),  # 7
    (8, TType.MAP, 'Properties', (TType.STRING, 'UTF8', TType.STRUCT, [TDimension, None], False), None, ),  # 8
...
TGraph.thrift_spec = (
    ...
    (2, TType.MAP, 'Nodes', (TType.STRING, 'UTF8', TType.STRUCT, [TNode, None], False), None, ),  # 2
    (3, TType.MAP, 'Edges', (TType.STRING, 'UTF8', TType.STRUCT, [TRelation, None], False), None, ),  # 3
    (4, TType.I32, 'RepresentationType', None, None, ),  # 4
)
...
TMemoryChunk.thrift_spec = (
    ...
    (3, TType.STRUCT, 'Graph', [TGraph, None], None, ),  # 3
    (4, TType.I16, 'Capacity', None, None, ),  # 4
    (5, TType.DOUBLE, 'AttentionLevel', None, None, ),  # 5
    (6, TType.DOUBLE, 'DecayLevel', None, None, ),  # 6
    (7, TType.DOUBLE, 'Importance', None, None, ),  # 7
    (8, TType.DOUBLE, 'Evaluation', None, None, ),  # 8
)
