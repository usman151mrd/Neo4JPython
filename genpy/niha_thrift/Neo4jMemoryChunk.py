...
class Iface(object):
    def create(self, memoryChunk):
        ...
        memoryChunk.create_memory_chunk()
    ...
    def retrieve(self, query):
        ...
        """
        n4j = Neo4jMemoryChunk()
        n4j.retrieve_memory_chunk(query)

    def update(self, memoryChunk, neo4Id):
        """
        Parameters:
         - neo4Id
        ...
        """
        n4j = Neo4jMemoryChunk()
        n4j.update_memory_chunk(neo4Id)
    ...
    def delete(self, neo4Id):
        ...
        """
        n4j = Neo4jMemoryChunk()
        n4j.delete_memory_chunk(neo4Id)
...
class Client(Iface):
    ...
    def create(self, memoryChunk):
        ...
        """
        self.send_create(memoryChunk)
        return self.recv_create()

    def send_create(self, memoryChunk):
    ...
    def update(self, memoryChunk, neo4Id):
        ...
        """
        self.send_update(memoryChunk, neo4Id)
        return self.recv_update()

    def send_update(self, memoryChunk, neo4Id):
...
class Processor(Iface, TProcessor):
    ...
    def process_create(self, seqid, iprot, oprot):
        ...
        result = create_result()
        try:
            result.success = self._handler.create(args.memoryChunk)
    ...
    def process_update(self, seqid, iprot, oprot):
        ...
        result = update_result()
        try:
            result.success = self._handler.update(args.memoryChunk, args.neo4Id)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except TApplicationException as ex:
