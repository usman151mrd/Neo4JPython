...
class Client(Iface):
    ...
    def create(self, node):
        ...
        """
        self.send_create(node)
        return self.recv_create()

    def send_create(self, node):
    ...
    def update(self, node, neo4Id):
        ...
        """
        self.send_update(node, neo4Id)
        return self.recv_update()

    def send_update(self, node, neo4Id):
...
class Processor(Iface, TProcessor):
    ...
    def process_create(self, seqid, iprot, oprot):
        ...
        result = create_result()
        try:
            result.success = self._handler.create(args.node)
    ...
    def process_update(self, seqid, iprot, oprot):
        ...
        result = update_result()
        try:
            result.success = self._handler.update(args.node, args.neo4Id)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except TApplicationException as ex:
